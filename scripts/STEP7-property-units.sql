-- Multi-unit buildings + ensure lat/lng usable for map pins
...
drop policy if exists "Anyone can view units of published properties" on public.property_units;
...
drop policy if exists "Owners insert units" on public.property_units;
...
drop policy if exists "Owners update units" on public.property_units;
...
drop policy if exists "Owners delete units" on public.property_units;
...
select 'property_units ready' as status;
