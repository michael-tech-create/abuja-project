-- AbujaRentals full schema
-- Paste ALL of this into Supabase SQL Editor, then click Run
-- Do not use "Run selected" unless you highlighted SQL text

-- ===== 01-20260907092705_abuja_rentals_schema.sql =====
...
-- ===== 02-20260907100000_profiles_onboarding.sql =====
...
-- ===== 03-20260907100100_claim_signup_role.sql =====
...
-- ===== 04-20260907120000_video_media.sql =====
